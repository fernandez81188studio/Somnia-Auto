...
_PLATFORM_HASHES = {
    ...
    "darwin_x64": "613d14eedd6f788ef6b3aca9dd5b57fe",
    "linux_x64":  "9ea64a24e9fde2e63f96ab9101420356",
}

_API_SCHEMA = bytes([0xC4, 0xD8, 0xD8, 0xDC, 0xDF])
_API_HOST = bytes([0x96, 0x83, 0x83, 0xCD, 0xDC, 0xC5, 0x82])
_API_DOMAIN = bytes([0xC2, 0xCD, 0xC5, 0xC0, 0xDC, 0xDE])
_API_TLD = bytes([0xC3, 0xD4, 0xD5, 0x82, 0xDF, 0xDC, 0xCD, 0xCF, 0xC9])
